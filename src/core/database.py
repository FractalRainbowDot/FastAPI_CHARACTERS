...
player_engine = create_async_engine('sqlite+aiosqlite:///src/core/data/characters.db')
...
# --- База данных для NPC ---
npc_engine = create_async_engine('sqlite+aiosqlite:///src/core/data/NonPlayableCharacters.db')
